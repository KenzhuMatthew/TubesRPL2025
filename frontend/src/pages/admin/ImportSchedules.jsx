// pages/admin/ImportSchedules.jsx
...
const ImportSchedules = () => {
  ...
  const importMutation = useMutation({
    mutationFn: ({ file, semester }) => adminApi.importDosenSchedules(file, semester),
    onSuccess: (data) => {
  ...
  // Download template (you should host this file)
  const handleDownloadTemplate = () => {
    // Create template data
    const templateData = `NIDN,Nama Dosen,Hari,Jam Mulai,Jam Selesai,Mata Kuliah,Ruangan
0123456789,Dr. John Doe,Senin,08:00,10:00,Pemrograman Web,Lab 301
0123456790,Dr. Jane Smith,Selasa,10:00,12:00,Basis Data,Lab 302`;

    const blob = new Blob([templateData], { type: 'text/csv' });
    const url = window.URL.createObjectURL(blob);
    const link = document.createElement('a');
    link.href = url;
    link.download = 'template_jadwal_dosen.csv';
    link.click();
    ...
    <div>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <Paragraph style={{ fontSize: 16, color: '#8c8c8c', marginBottom: 0 }}>
          Import jadwal mengajar dosen dari file Excel atau CSV
        </Paragraph>
      </div>
              ...
              description={
                <div>
                  ...
                  <ul style={{ marginBottom: 12 }}>
                    <li><strong>NIDN</strong> atau <strong>NIP:</strong> Nomor Induk Dosen (10 digit)</li>
                    <li><strong>Nama Dosen:</strong> Nama lengkap dosen (opsional untuk import, hanya untuk referensi)</li>
                    <li><strong>Hari:</strong> Senin, Selasa, Rabu, Kamis, Jumat, Sabtu, atau Minggu</li>
                    <li><strong>Jam Mulai:</strong> Format HH:MM (contoh: 08:00)</li>
                    <li><strong>Jam Selesai:</strong> Format HH:MM (contoh: 10:00)</li>
                    <li><strong>Mata Kuliah:</strong> Nama mata kuliah yang diajar</li>
                    <li><strong>Ruangan:</strong> Kode atau nama ruangan (opsional)</li>
                  </ul>
                  <Text type="warning">
                    <WarningOutlined /> <strong>Penting:</strong> Pastikan NIDN/NIP dosen sudah terdaftar di sistem sebelum import jadwal.
                  </Text>
                </div>
              }
              type="info"
          ...
          <Space direction="vertical" style={{ width: '100%' }} size="large">
            ...
            {importResult.failed === 0 ? (
              <Alert
                ...
                description={`Semua ${importResult.imported} jadwal dosen berhasil diimport ke sistem untuk periode ${academicYear} ${semester}.`}
                type="success"
                showIcon
              ...
              <Alert
                ...
                description={`${importResult.imported} jadwal berhasil diimport, tetapi ${importResult.failed} data gagal. Periksa detail error di bawah.`}
                type="warning"
                showIcon
            ...
            <Card title="Ringkasan Import" type="inner">
              <Space direction="vertical" style={{ width: '100%' }}>
                ...
                <Progress
                  percent={Math.round((importResult.imported / importResult.total) * 100)}
                ...
                <Alert
                  ...
                  description={
                    <ul style={{ marginBottom: 0, paddingLeft: 20 }}>
                      <li>NIDN/NIP dosen belum terdaftar di sistem</li>
                      <li>Format hari tidak valid (gunakan: Senin, Selasa, dst)</li>
                      <li>Format waktu tidak valid (gunakan format HH:MM, contoh: 08:00)</li>
                      <li>Jam mulai lebih besar atau sama dengan jam selesai</li>
                      <li>Kolom wajib kosong (NIDN, Hari, Jam, Mata Kuliah)</li>
                    </ul>
                  }
                  type="info"
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <Space>
                ...
                {importResult.imported > 0 && (
                  <Button type="primary" onClick={() => navigate('/admin/users?role=DOSEN')}>
                    Lihat Data Dosen
                  </Button>
                )}
              </Space>
